    ...
    <CalendarContainer>
      <CalendarWrapper>
        <VueCalWrapper
          ...
          currentTimeLineColor="#4ECDC4"
          currentTimeLineStyle="solid"
          currentTimeLineWidth={3}
          currentTimeLineOpacity={0.9}
          ...
          eventPadding="10px 15px"
          eventFontSize="0.9em"
          eventFontWeight={500}
          eventLetterSpacing="0.2px"
          eventBoxShadow="0 4px 12px rgba(0, 0, 0, 0.25)"
          eventTransition="all 0.3s ease"
          todayButton={false}
